...
"
echo -e  "     \e[1m\e[32m▂▃▄▅▆▇▓▒░ \033[1mCoded By \e[33mMrTech-AK {GITHUB}\e[1m\e[32m░▒▓▇▆▅▄▃▂"
cd $HOME
...
echo
echo 
echo -e "\033[1m\e[1;32m Thank You for using T-Customizer \033[33mFollow MrTech-AK on GITHUB \n
       Termux is Customized \033[31mExit \033[37mand \033[32mLogin\e[0m"
echo
echo
